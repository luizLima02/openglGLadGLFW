...
class Mesh
{
    ...
    Mesh(const Mesh& obj){
        this->verticesQnt = obj.verticesQnt;
        this->indicesQnt = obj.indicesQnt;
    ...
    void print(){
        for(int i = 0; i < this->verticesQnt; i++){
            std::cout << this->vertices[i].px << " " << this->vertices[i].py << " " <<  this->vertices[i].pz << " " <<  this->vertices[i].nx  << " " <<  this->vertices[i].ny << " " <<  this->vertices[i].nz << " " <<  this->vertices[i].tx << " " <<  this->vertices[i].ty << "\n";
        }
    }
